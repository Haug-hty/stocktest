...
<script type="text/javascript">
    ...
    export default {
      ...
      methods: {
        ...
        //页面初始化
        newdata(){
          this.testPlan.planForm.name = '',
          this.testPlan.planForm.type = '',
          this.testPlan.dag_id = '',
          this.testPlan.Env1value = '',
          this.testPlan.Env2value = '',
          this.testPlan.SDKversion = '',
          this.testPlan.start_date = '',
          this.testPlan.round_interval_sec = 3,
          this.testPlan.run_times = 1,
          this.testPlan.quote_detail = '',
          this.testPlan.tag_id = '',
          this.testPlan.tag_sha = '',
          this.testPlan.tag_id_1 = '',
          this.testPlan.tag_sha_1 = '',
          this.testPlan.marketPermission = [],
        ...
        postInfo() {
          ...
          this.getTestCasePlan_action_addinfo()
            .then(res => {
              this.$message({
                type: "success",
                message: "新建成功",
